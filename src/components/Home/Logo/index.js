...
const Logo=()=>{
    ...
    useEffect(()=>{
        ...
        // gsap.timeline().fromTo(outlineLogoRef1.current, {
        //     drawSVG: 10,
        ...
        //     ease: "power4.inOut"
        // })
        // gsap.timeline().fromTo(outlineLogoRef2.current, {
        //     drawSVG: 0,
        ...
        //     ease: "power4.inOut"
        // })
        // gsap.timeline().fromTo(outlineLogoRef3.current, {
        //     drawSVG: 0,
        ...
        //     ease: "power4.inOut"
        // })
        // gsap.timeline().fromTo(outlineLogoRef4.current, {
        //     drawSVG: 0,
    ...
    return (
        <div ref={bgRef} className="logo-container">
            ...
            version="1.1"
            viewBox="0 0 178.4 156.1" 
            width="100%" 
            xmlns="http://www.w3.org/2000/svg" >
            <defs/>
            <g id="Mask-Group-2">
            <path className="path1" ref={outlineLogoRef1} d="M131.473 148.385L60.0155 24.9832L60.0155 141.8C60.0155 145.439 60.2018 148.931 60.2546 148.711L131.473 148.385Z" fill="none" opacity="0.75" stroke="#f9db3a" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.8"/>
            <path className="path2" ref={outlineLogoRef2} d="M121.645 2.441L50.1878 125.843L50.1878 9.02767C50.1878 5.3892 50.4255 1.51841 50.4797 0.881989L121.645 2.441Z" fill="none" opacity="1" stroke="#ffd700" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.8"/>
            <path className="path3" ref={outlineLogoRef3} d="M126.991 153.517L55.57 28.031L55.57 146.821C55.57 150.521 55.6911 153.603 55.9184 153.702L126.991 153.517Z" fill="none" opacity="1" stroke="#1683dd" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.8"/>
            <path className="path4" ref={outlineLogoRef4} d="M126.991 7.22409L55.57 132.71L55.57 13.922C55.57 10.2221 55.668 7.49437 55.7824 7.43935L126.991 7.22409Z" fill="#0071bc" fillOpacity="0" fillRule="nonzero" opacity="1" stroke="#1c7dd7" strokeLinecap="round" strokeLinejoin="round" strokeWidth="0.8"/>
            </g>
            </svg>
