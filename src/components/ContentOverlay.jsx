...
import unmute from "../assets/volume.svg";
...
const Mute = () => (
  ...
  >
    <path
      id="primary"
      d="M17.45,2.11a1,1,0,0,0-1,.08L9.84,7H6A2,2,0,0,0,4,9v6a2,2,0,0,0,2,2H9.84l6.57,4.81a1,1,0,0,0,1,.08A1,1,0,0,0,18,21V3A1,1,0,0,0,17.45,2.11Z"
      style={{ fill: "#925022" }}
    ></path>
    <path
      id="secondary"
      d="M21,19.63a.94.94,0,0,1-.59-.2L2.41,6.17a1,1,0,0,1-.22-1.39,1,1,0,0,1,1.4-.22l18,13.26A1,1,0,0,1,21,19.63Z"
      style={{ fill: "black" }}
    ></path>
  </svg>
);

function ContentOverlay({ isSoundOn, setIsSoundOn }) {
  return (
    <>
      ...
      <button
        ...
        className={`${isSoundOn ? "on" : ""} pointer-events-auto
        
        `}
      >
        {/* <img
          className="w-7 h-7 object-contain"
          src={isSoundOn ? Mute : Unmute}
        /> */}
        <div className="w-7 h-7 object-contain fill-white">
          {isSoundOn ? <Unmute /> : <Mute />}
        </div>
      </button>
    </>
  );
